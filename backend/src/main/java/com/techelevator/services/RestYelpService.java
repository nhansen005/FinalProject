...
public class RestYelpService implements YelpService {
    ...
    public List<Business> getBusinessesNoRadius(String zipCode, String category) {
        YelpBusinessesResponse response = restTemplate.exchange(BASE_URL + "businesses/search?location={zipCode}&term={category}",
    ...
    public List<Business> getBusinessesWithRadius(String zipCode, String category, String radius) {
        YelpBusinessesResponse response = restTemplate.exchange(BASE_URL + "businesses/search?location={zipCode}&term={category}&radius={radius}",
